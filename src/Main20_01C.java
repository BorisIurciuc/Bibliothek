public class Main20_01C {
  //    Написать метод, который добавит один элемент с заданным значением в конец массива

  public static int[] add(int[] arr, int value) {
    // временный массив для добавления нового элемент
    int[] temp = new int[arr.length + 1];
    for (int i = 0; i < arr.length; i++) { // каждый элемент по одному записываем из старого в новый
      temp[i] = arr[i];
    }
